...
var ASPlatforms = {
    ...
    $.fn.html5zoo = function(G) {
        ...
        this.each(function() {
            ...
            var j = {
                ...
                navpreviewarrowimage: 'images/preview-arrow.png',
    ...
    $.fn.threedTransition = function(d, e, f, g, j, k) {
        ...
        for (i = 0; i < g.slicecount; i++) {
            ...
            var p = $("<div class='html5zoo-img-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;'></div>");
            p.append(o);
            ...
            var r = $("<div class='html5zoo-img-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;'></div>");
            r.append(q);
            var s = $("<div class='html5zoo-img-slice-left-" + d + " ' style='display:block;position:absolute;left:2px;top:2px;width:" + (h - 1) + "px;height:" + (h - 1) + "px;overflow:hidden;outline:2px solid transparent;'></div>");
            var t = $("<div class='html5zoo-img-slice-right-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:" + (h - 1) + "px;height:" + (h - 1) + "px;overflow:hidden;outline:2px solid transparent;'></div>");
    ...
    $.fn.threedHorizontalTransition = function(d, e, f, g, j, k) {
        ...
        for (i = 0; i < g.slicecount; i++) {
            ...
            var r = $("<div class='html5zoo-img-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;'></div>");
            r.append(q);
            var s = $("<div class='html5zoo-img-slice-left-" + d + " ' style='display:block;position:absolute;left:2px;top:2px;width:" + (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;'></div>");
            var t = $("<div class='html5zoo-img-slice-right-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:" + (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;'></div>");
